...
@layer utilities {
  ...
  .\[color\:red\]\/50\! {
    color: color-mix(in srgb, red 50%, transparent)!important;
  }
  .text-black {
  ...
  .inset-shadow {
    --tw-inset-shadow: inset 0 2px 4px rgb(0 0 0 / 0.05);
  ...
  .\!transition {
    transition-property: color, background-color, border-color, text-decoration-color, fill, stroke, opacity, box-shadow, transform, translate, scale, rotate, filter, -webkit-backdrop-filter, backdrop-filter!important;
  ...
  .ease-in {
    transition-timing-function: var(--transition-timing-function-in, cubic-bezier(0.4, 0, 1, 1));
  }
  .ease-in-out {
